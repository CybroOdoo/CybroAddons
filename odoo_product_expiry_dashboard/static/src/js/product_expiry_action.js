...
import { useRef, Component,  onWillStart, onMounted, useState} from "@odoo/owl";
...
class ProductExpiryDashboard extends Component {
   ...
   fetch_products_expiry(start_date, end_date) {
    //Fetch the data to be displayed on the tiles of the dashboard.
      ...
      var self = this
      jsonrpc('/web/dataset/call_kw/stock.lot/get_product_expiry',{
                model: 'stock.lot',
    ...
    //Function for rendering the graph of expired products
      ...
      var date_dict = { 'start_date': start_date, 'end_date': end_date }
      var self = this
      let data = jsonrpc('/web/dataset/call_kw/stock.lot/get_expired_product',{
                model: 'stock.lot',
...
//        (eighty-nine days from the thirty-first day).
    ...
    //their category
      ...
      var self = this
      jsonrpc('/web/dataset/call_kw/stock.lot/get_near_expiry_category',{
                model: 'stock.lot',
        ...
        var div = self.rootRef.el.querySelector('.nearby_expire_cat')
        new Chart(ctx, {
          type: 'line',
          data: {
            labels: product_category_array,
    ...
    //Function for rendering graph of products expiring in 7 days
      ...
      var nearby_expire_qty = []
      var self = this
      jsonrpc('/web/dataset/call_kw/stock.lot/get_near_expiry_product',{
                model: 'stock.lot',
    ...
    //their location
      ...
      var nearby_expire_qty = []
      var self = this
      jsonrpc('/web/dataset/call_kw/stock.lot/get_expire_product_location',{
                model: 'stock.lot',
    ...
    //their warehouse
      ...
      var nearby_expire_qty = []
      var self = this
      jsonrpc('/web/dataset/call_kw/stock.lot/get_expire_product_warehouse',{
                model: 'stock.lot',
