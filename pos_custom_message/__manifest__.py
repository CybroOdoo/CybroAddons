...
#############################################################################
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'pos_custom_message/static/src/js/Popup/AlertPopup.js',
            'pos_custom_message/static/src/js/Popup/InfoPopup.js',
            'pos_custom_message/static/src/js/Popup/WarningPopup.js',
            'pos_custom_message/static/src/js/Popup/pos_popup_templates.xml',
            'pos_custom_message/static/src/js/pos_custom_message_popup.js',
        ],
    },
