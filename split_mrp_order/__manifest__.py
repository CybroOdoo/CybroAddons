...
#############################################################################
{
    ...
    another manufacturing order on odoo system. this module also helps to
    split order with the number of qty & number of split manufacturing orders
    and split manually by numbers""",
