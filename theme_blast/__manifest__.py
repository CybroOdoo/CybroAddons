...
#############################################################################
{
    'name': 'Theme Blast',
    'version': '15.0.1.0.0',
    'summary': 'Theme Blast provides attractive and unique front end theme '
               'mainly suitable for eCommerce website',
    'description': """Includes many custom designed snippets which facilitates
                   to add better user experience.""",
    'category': 'Theme',
    ...
    'images': [
        ...
        'static/description/blast_screenshot.png',
    ],
    'license': 'AGPL-3',
    'application': False,
    'installable': True,
