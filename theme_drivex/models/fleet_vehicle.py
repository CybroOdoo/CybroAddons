...
class FleetVehicle(models.Model):
    ...
    publish_on_homepage = fields.Boolean(
        ...
        default=False, help='Show this vehicle on the homepage.')
    ...
    feature_ids = fields.Many2many('fleet.vehicle.feature',
                                   string="Rental Features",
                                   help='Features of the vehicle.')
    vehicle_image_ids = fields.One2many('fleet.vehicle.image',
                                        'vehicle_id',
            ...
            if record.publish_on_homepage:
                ...
                if count > 3:
                    raise ValidationError(
                        "You can only publish a maximum of 3 vehicles on the homepage "
                        "premium section. Please disable another vehicle first.")
