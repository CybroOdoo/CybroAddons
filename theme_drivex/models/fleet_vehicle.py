...
#############################################################################
"""
This module defines extensions to the Fleet Vehicle model.
"""
...
class FleetVehicle(models.Model):
    ...
    publish_on_homepage = fields.Boolean(
        string="Show on Homepage Premium Section", default=False,
        help='Show this vehicle on the homepage.')
    daily_rate = fields.Monetary(
        string="Daily Rental Rate", currency_field='currency_id',
    ...
    website_description = fields.Html(
        ...
        sanitize_attributes=False, help='Description shown on the website.')
    feature_ids = fields.Many2many(
        'fleet.vehicle.feature', string="Rental Features",
        help='Features of the vehicle.')
    vehicle_image_ids = fields.One2many(
        'fleet.vehicle.image', 'vehicle_id',
        string="Gallery Images", help='Images of the vehicle.')
            ...
            if record.publish_on_homepage:
                ...
                if count > 3:
                    raise ValidationError(
                        "You can only publish a maximum of 3 vehicles"
                        " on the homepage premium section. Please disable another vehicle first.")
