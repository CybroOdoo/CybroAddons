...
class CrmLead(models.Model):
    ...
    oppo_code = fields.Char(string="Opportunity Sequence Code",
                            help='Unique code for each opportunity', readonly=True)
    sequence_create = fields.Boolean(compute="_compute_sequence_create", string='Create Sequence',
                                     help='Creates unique code for each opportunity')
    ...
    def create(self, vals):
        ...
        if oppo.sequence_create:
            oppo.oppo_code = self.env["ir.sequence"].next_by_code("code.opportunity.crm")
        return oppo
