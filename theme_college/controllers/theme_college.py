...
class College(http.Controller):
    ...
    def get_college_location(self):
        ...
        if not college_location:
            return (http.Response(template='theme_college.empty_location')).render()
        else:
            values = {
    ...
    def view_country_details(self, college_location_id):
        ...
        college_location = request.env['college.location'].sudo().browse(
            college_location_id)
        values = {
            'college_location': college_location
        }
