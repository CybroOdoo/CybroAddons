...
#############################################################################
{
    'name': 'Odoo 20 Accounting for Community : Financial Report, PDC, Assets, Bank Reconciliation, Lock Dates',
    'version': '20.0.1.0.0',
    'category': 'Accounting',
    ...
    'description': """ 
      ...
      =========================================
      Restores full accounting capabilities to Odoo 20 Community Edition.
        ...
        * Customer follow-ups and recurring payments, odoo20 accounting, odoo20 assets, odoo20 pdc, odoo20 full accounting.
    """,
