...
class TestAiBotChannel(TransactionCase):
    ...
    def setUp(self):
        ...
        self.env['ir.config_parameter'].sudo().set_str('web.base.url', 'https://odoo.example.com')
        self.env['ir.config_parameter'].sudo().set_str('bot_gateway.webhook_secret', 'secret-key')
