...
class AiGenerateMcpKey(models.TransientModel):
    ...
    def _get_mcp_url(self) -> str:
        ...
        Always returns a https:// URL — Odoo may receive requests over plain
        http when sitting behind a reverse proxy or ngrok tunnel that terminates
        TLS, so we force the secure scheme here.
        """
        ...
        # Force HTTPS — TLS is terminated by the reverse proxy / ngrok upstream
