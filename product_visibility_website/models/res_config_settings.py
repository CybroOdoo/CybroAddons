...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        """This function is responsible for setting configuration parameters
         ...
         These paramJigin Keters are used to control various settings and
         behaviors of the module."""
        res = super(ResConfigSettings, self).set_values()
        self.env['ir.config_parameter'].sudo().set_param(
            'website_product_visibility.product_visibility_guest_user',
            self.product_visibility_guest_user)
        self.env['ir.config_parameter'].sudo().set_param(
            'website_product_visibility.product_visibility_portal_user',
