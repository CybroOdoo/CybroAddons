...
class TicketStage(models.Model):
    ...
    'Resolved', or 'Closed'. Stages are used to organize and track the progress of
    ...
    name = fields.Char(string='Name', help='The name of the stage. This field'
                                           ...
                                           'is displayed in various views and'
                                           'reports.')
    ...
    folded = fields.Boolean(string='Folded in Kanban',
                            help='Whether the stage is folded in the Kanban'
                                 ...
                                 'expanded by clicking on it.This field is used'
                                 ' to control the behavior of the Kanban view.')
