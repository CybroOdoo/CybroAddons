...
class ResUsers(models.Model):
    """ Inherited th res users to apply the readonly feature
     to the unit price. """
    _inherit = 'res.users'
    ...
    readonly_unit_price_invoicing = fields.Boolean(
        ...
        help='If enabled, the Unit Price in the Invoice Lines'
             ' will be readonly for this user.')
    is_admin_boolean = fields.Boolean(compute='_compute_is_admin_boolean',
                                      help='To check the readonly'
                                           ' access for the user.')
