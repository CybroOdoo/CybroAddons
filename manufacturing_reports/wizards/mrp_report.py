...
class MrpReportWizard(models.TransientModel):
    """
    Wizard to generate Manufacturing Order reports with optional
    filters (product, state, date, responsible) in XLSX or PDF format.
    """
    _name = 'mrp.report.wizard'
    _description = 'MRP Report Wizard'
    ...
    def check_report(self):
        ...
        if not mrp_orders:
            raise UserError(_("No data is available to print"))
