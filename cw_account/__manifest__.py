...
################################################################################
{
    ...
    'version': '15.0.1.0.0',
    'category': 'Accounting',
    'summary': """Helps to add Catch Weight of products in Accounting module""",
    'description': """Catch weight is simply a parallel unit of measure used to
     ...
     system in the Accounting module.We can invoice products based on their 
     Catch Weight.""",
    'author': 'Cybrosys Techno Solutions',
    'company': 'Cybrosys Techno Solutions',
    'maintainer': 'Cybrosys Techno Solutions',
    'website': 'https://www.cybrosys.com',
    'depends': ['account', 'cw_stock'],
    'data': [
