...
class TargetAchieve(models.Model):
    """Model for target achievements"""
    _name = 'target.achieve'
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = 'Target Achieve'

    name = fields.Char(string='Name', compute='_compute_name', store=True,
                       help="Auto created name which is a combination of "
                            "Salesperson, timespan and team name.")
    ...
    currency_id = fields.Many2one('res.currency',
                                  ...
                                  help="Company currency field to"
                                       " show the monetary field.")
    _sql_constraints = [
