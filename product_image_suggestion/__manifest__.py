...
##############################################################################
{
    ...
    'description': """
        Product images can be searched from the product form using bing image
        downloader and it can be set as the product display image. 
    """,
    ...
    'external_dependencies': {'python': ['PIL', 'python-resize-image']},
