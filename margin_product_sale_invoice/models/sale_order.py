...
class SaleOrderLine(models.Model):
    ...
    cost_price_sale = fields.Float(string='Cost', compute='compute_cost_price')
    margin_amount_sale = fields.Float(string='Margin',
    ...
    def action_confirm(self):
        ...
        for record in self:
            if record.order_line.product_id:
                ...
                record.margin_percent_sale = record.margin_amount_sale_total / record.amount_total * 100
        return res
