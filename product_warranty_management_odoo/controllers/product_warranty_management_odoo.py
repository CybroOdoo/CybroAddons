...
class WarrantyClaimController(http.Controller):
    ...
    def get_sale_order_data(self, partner_id):
        ...
        return request.env['sale.order'].sudo().search_read(
    ...
    def get_sale_order_line_data(self, order_id):
        ...
        return request.env['sale.order.line'].sudo().search_read(
            [('order_id', '=', order_id)],
            fields=['product_id']
        )
    ...
    def warranty_claim_count(self, sale_order_id):
        ...
        return request.env['warranty.claim'].sudo().search_count([
