...
class TestPurchaseOrderLineBarcode(TransactionCase):
    """Test cases for purchase.order.line barcode scanning."""
    ...
    def test_onchange_barcode_scan(self):
        ...
        line = self.env['purchase.order.line'].new({
            ...
            'barcode_scan': 'purchase_prod_123',
        })
