...
class Uom(models.Model):
    """Class inheriting uom model for listing out the products in their corresponding unit of measure."""
    _inherit = 'uom.uom'
    ...
    purchase_uom_products = fields.Integer(compute='compute_product_count',
                                           ...
                                           help="Compute purchase product count in a UOM")
    ...
    def compute_product_count(self):
        """Function for computing the count of products with the corresponding UOM"""
        for record in self:
