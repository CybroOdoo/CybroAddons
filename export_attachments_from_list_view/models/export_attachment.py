...
class ExportAttachment(models.Model):
    ...
    act_window_id = fields.Many2one('ir.actions.act_window',
                                       string="Act Window", readonly="True",
                                       help='Select the window action that has been created',
                                       copy=False)
    ...
    def action_create(self):
        ...
        self.states = 'running'
        act_window_id = self.env['ir.actions.act_window'].create([{
        ...
        self.act_window_id = act_window_id.id

    def action_unlink(self):
        """ Remove the contextual actions created for the server actions. """
        self.states = 'cancel'
        self.act_window_id.unlink()
