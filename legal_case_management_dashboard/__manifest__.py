...
###############################################################################
{
    ...
    with interactive dashboard cards and graphical insights.""",
    ...
    'assets': {
        'web.assets_backend': [
            'legal_case_management_dashboard/static/src/js/legal_case_dashboard.js',
            'legal_case_management_dashboard/static/src/xml/legal_case_dashboard_template.xml',
