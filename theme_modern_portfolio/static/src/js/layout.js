...
/**
 * Theme Modern Portfolio - Layout Interactions
 * Handles header shadow, mobile menu, dropdowns, and animations
 */

function initModernPortfolio() {
    ...
    const subpara = document.querySelector(".subpara");
    if (subpara) {
...
if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initModernPortfolio);
} else {
    initModernPortfolio();
}

// Also initialize when Odoo's public widget system is ready
registry.category("public.interactions").add("theme_modern_portfolio.layout", {
    start() {
        initModernPortfolio();
    }
});