...
/**
 * Featured Projects Interaction
 */
export class FeaturedProjectsGrid extends Interaction {
    static selector = ".s_portfolio_featured_project";
...
registry.category("public.interactions").add("theme_modern_portfolio.featured_projects_grid", FeaturedProjectsGrid);
