...
class SaleOrderLine(models.Model):
    ...
    is_duplicated = fields.Boolean(default=False,copy=False)
...
class SaleOrder(models.Model):
    ...
    def action_confirm(self):
        """Create delivery line from product shipping method."""

        # website orders skip this logic
        if self.website_id:
            return super().action_confirm()
        # select only lines that:
        # 1: have a shipping method
        # 2: are NOT duplicated lines
        order_lines_with_shipping = self.order_line.filtered(
            lambda line: line.product_template_id.shipping_method_id
        ...
        vals_list = [{
            ...
            'product_uom_id': line.product_template_id.shipping_method_id.product_id.uom_id.id,
    ...
    def copy(self, default=None):
        ...
        # Mark all duplicated lines in the new Sale Order
        new_order.order_line.write({'is_duplicated': True})
        return new_order
