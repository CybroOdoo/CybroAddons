...
class ProductCategory(models.Model):
    ...
    def _check_archive(self):
        """Prevents archiving categories that have products linked to them."""
    ...
    def _compute_product_count(self):
        """Computes the total number of products assigned to each category."""
    ...
    def _build_hierarchy_html(self, category):
        """Generates recursive HTML structure for category hierarchy display."""
        return f"""
    ...
    def _compute_category_hierarchy_html(self):
        """Builds styled HTML representation of the category hierarchy."""
        for rec in self:
