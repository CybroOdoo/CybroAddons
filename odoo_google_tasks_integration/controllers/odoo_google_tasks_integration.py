...
class GoogleTaskAuth(http.Controller):
    ...
    def get_auth_code(self, **kw):
       ...
       This method is responsible for retrieving an authentication code from
       Google,exchanging it for access tokens, and storing these tokens along
       with associated information in the project credential model."""
