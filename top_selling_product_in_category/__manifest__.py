...
#############################################################################
{
    ...
    'assets': {
        'web.assets_frontend': [
            'top_selling_product_in_category/static/src/js/top_selling_'
            'products.js',
            'top_selling_product_in_category/static/src/xml/top_products_'
            'templates.xml',
            'top_selling_product_in_category/static/src/css/products_'
            'carousel.css',
        ]},
