...
class SaleOrder(models.Model):
    """ Inheriting the sale order model to add the fields and direct
     send the email button. """
    _inherit = 'sale.order'
    ...
    def action_direct_send_sale(self):
        """ Sending a direct sales email to the customer """
        ...
        if is_direct_send_email_sale:
            ...
            if self.state in sale_state:
                ...
                if template:
                    ...
                    raise exceptions.ValidationError(sale_state[self.state]['error_msg'])
        else:
