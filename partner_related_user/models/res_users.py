...
class ResUsers(models.Model):
    ...
    sales_user = fields.Boolean(string='Sales User',
                                help='field for Sales user filter')
    invoice_user = fields.Boolean(string='Invoice User',
                                  help='field for Invoice user filter')
    purchase_user = fields.Boolean(string='Purchase User',
    ...
    pos_user = fields.Boolean(string='POS User',
                              help='field for POS user filter')
    project_user = fields.Boolean(string='Project User',
                                  help='field for Project user filter')
    manufacturing_user = fields.Boolean(string='Manufacturing User',
                                        help='field for Manufacturing user'
                                             'filter')
