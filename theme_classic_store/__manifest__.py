...
#############################################################################
{
    ...
    'depends': ['web', 'website_blog', 'website_sale_wishlist', 'website_sale',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            '/theme_classic_store/static/src/xml/category_snippet_template.xml',
            '/theme_classic_store/static/src/xml/trending_snippet_template.xml',
