...
//import { animations } from '@web/animation/core';
import { renderToElement } from "@web/core/utils/render";

publicWidget.registry.ecoFoodRecentlyAdded = publicWidget.Widget.extend({
    selector: '.recently_added_carousel',
    async start() {
        var data = await rpc('/get_recently_added_products')
        if (data) {
