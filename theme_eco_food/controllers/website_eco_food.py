...
class WebsiteEcoFood(http.Controller):
    ...
    @http.route('/get_best_seller', auth="public", type='jsonrpc')
    ...
    @http.route('/get_featured_products', auth="public", type='jsonrpc')
    ...
    @http.route('/get_recently_added_products', auth="public", type='jsonrpc')
    ...
    @http.route('/get_new_arrivals', auth="public", type='jsonrpc')
    ...
    @http.route('/get_testimonials', auth="public", type='jsonrpc')
