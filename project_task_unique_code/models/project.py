...
class Project(models.Model):
    ...
    project_short_code = fields.Char(string="Short Code", required=True,
                                     help="Set a short code here and this "
                                          "will be used to generate serial "
                                          "number for the project's tasks")
    sequence_id = fields.Many2one(
        'ir.sequence', 'Reference Sequence',
        check_company=True, copy=False, help="Project Sequence")
    ...
    def create(self, vals_list):
        """extend create method to create project sequence"""
