...
class ResConfigSettings(models.TransientModel):
    """ Extend the 'res.config.settings' model to manage configuration
    settings for enabling/disabling the chatter feature."""
    ...
    @api.model
    def get_values(self):
        """ Override the 'get_values' method to retrieve the selected models
