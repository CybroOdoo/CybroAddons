...
class WebsiteFleetService(http.Controller):
    ...
    def service_booking(self):
        ...
        vehicle_ids = (request.env["fleet.vehicle.model"].sudo().search([
            ("vehicle_type", "=", "car")]))
    ...
    def success_page(self, **post):
        ...
        booking_id = (request.env["service.booking"].sudo().create({
        ...
        return request.render("website_fleet_service.car_service_booking_success_page", {"booking_id": booking_id})
    ...
    def service_package_details(self):
        ...
        return http.request.render("website_fleet_service.service_package_page",{
            "service_package_ids": service_package_ids, "service_line_ids": service_line_ids})
