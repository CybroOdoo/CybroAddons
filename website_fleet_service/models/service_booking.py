...
class ServiceBooking(models.Model):
    ...
    def action_view_worksheet(self):
        """ Smart button to view the corresponding worksheet of service booking """
        return {
    ...
    def action_create_invoice(self):
        ...
        invoiced_amount = sum(self.env["account.move"].search([
                ...
                "invoice_line_ids": [
                    (0, 0, {
                        "name": "{} / {} / Service Package: {}".format(
                            self.model_id.name, self.vehicle_no,
    ...
    def unlink(self):
        ...
        for rec in self:
            if rec.state != "draft":
                raise UserError(_(
                    "You can not delete a confirmed or a Invoiced service booking."))
        return super().unlink()
