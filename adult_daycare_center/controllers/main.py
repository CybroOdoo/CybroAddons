...
class RoomBooking(http.Controller):
    @http.route(['/assessment_request'], type='http', auth="public", website=True)
    def assessment_request(self, **kw):
        ...
        return request.render("adult_daycare_center.assessment_request_form", values)

    @http.route(['/assessment_request/submit'], type='http', auth="public", website=True, csrf=False)
    def assessment_request_submit(self, **kw):
        ...
        return request.render("adult_daycare_center.assessment_request_submit_template", vals)
