...
class ProductMultipleTag(models.TransientModel):
    """ Model to add the multiple product tags."""
    _name = 'product.multiple.tag'
    _description = 'Product Multiple Tag'
    ...
    product_ids = fields.Many2many(
        'product.product', string="Products", readonly=True, help='The product Variants')
    product_tmp_ids = fields.Many2many(
        'product.template', string="Products", readonly=True, help='The product templates.')
