...
<div>
  <tr>
    <td align="center">
      <img src="static/description/assets/screenshots/call_2.png" alt="Feature 1" width="500" style="border: none;"/>
    </td>
  </tr>
</div>

### Call Assistance Interface

<div>
  <tr>
    <td align="center">
      <img src="static/description/assets/screenshots/call_6.png" alt="Feature 1" width="500" style="border: none;border-radius: 5px;"/>
    </td>
  </tr>
</div>
<div>
  <tr>
    <td align="center">
     <span>After submitting the call, the call transcript becomes visible in the view.</span>
      <img src="static/description/assets/screenshots/call_10.png" alt="Feature 1" width="500" style="border: none;border-radius: 5px;"/>
    </td>
  </tr>
</div>
<div>
  <tr>
    <td align="center">
      <span>The module can generate a squad of assistants.</span>
      <img src="static/description/assets/screenshots/call_13.png" alt="Feature 1" width="500" style="border: none;border-radius: 5px;"/>
    </td>
  </tr>
</div>
...
1. **Clone the Repository**
   ...
   ```git clone https://github.com/cybrosystech/Ora-AI-Call.git```
