...
restored and downloaded using this module.

Configuration
=============
The auto_database_backup module should be installed ( Here is the link: https://apps.odoo.com/apps/modules/15.0/auto_database_backup/ )
