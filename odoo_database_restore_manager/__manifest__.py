...
###############################################################################
{
    'name': "Odoo Database Restore Manager Odoo15",
    'version': "15.0.1.0.0'",
    ...
    'description': """Easily Restore The Previous Database Backups Stored in Different Locations like Google Drive,
                    Dropbox, Onedrive, Nextcloud and Amazon S3, Odoo15, backup, restore""",
    ...
    'assets': {
        ...
        'web.assets_qweb': [
            '/odoo_database_restore_manager/static/src/xml/db_restore_dashboard.xml',
        ],
    },
