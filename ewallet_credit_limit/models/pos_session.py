...
class PosSession(models.Model):
    """Inherit POS Session to load loyalty card credit limit fields."""
    _inherit = 'pos.session'

    @api.model
    def _pos_ui_models_to_load(self):
        """Add loyalty.card to POS UI models to load."""
