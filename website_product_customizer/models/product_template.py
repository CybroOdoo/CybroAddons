...
class ProductTemplate(models.Model):
    ...
    design_bg_color_ids = fields.Many2many(
        ...
        'product_tmpl_id',
        'color_id',
        string="Design Background Colors",
    ...
    def _compute_design_template_count(self):
        """Compute the total number of pre-designed templates available for this product."""
        for product in self:
            product.design_template_count = len(product.design_template_ids)

    def action_open_designer_templates(self):
        """Open the designed templates available for this product."""
        self.ensure_one()
        return {
