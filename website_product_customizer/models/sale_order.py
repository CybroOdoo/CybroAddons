...
class SaleOrder(models.Model):
    ...
    def _compute_has_design_products(self):
        """Compute whether this order line has an attached customer design customization."""
        for order in self:
    ...
    def _compute_design_customization_count(self):
        """Compute how many lines this order line has a design customization."""
        for order in self:
...
class SaleOrderLine(models.Model):
    ...
    def _compute_is_designed(self):
        """Calculate whether this order line has an attached custom design."""
        for line in self:
