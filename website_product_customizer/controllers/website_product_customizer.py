...
class WebsiteProductDesigner(http.Controller):
    ...
    @http.route('/shop/designer/save', type='jsonrpc', auth='public', website=True)
    ...
    @http.route('/shop/designer/load_saved', type='jsonrpc', auth='public', website=True)
    ...
    @http.route('/shop/designer/save_area_config', type='jsonrpc', auth='user', website=True)
    ...
    @http.route('/shop/designer/add_to_cart', type='jsonrpc', auth='public', website=True)
    ...
    @http.route('/shop/designer/upload_image', type='jsonrpc', auth='public', website=True)
    ...
    @http.route('/shop/designer/get_templates', type='jsonrpc', auth='public', website=True)
    ...
    @http.route('/shop/designer/save_as_template', type='jsonrpc', auth='user', website=True)
    ...
    @http.route('/shop/designer/update_template', type='jsonrpc', auth='user', website=True)
    ...
    @http.route('/shop/designer/get_variant_info', type='jsonrpc', auth='public', website=True)
