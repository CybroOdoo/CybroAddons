...
###############################################################################
{
    ...
    each individual product, allowing businesses to assess the financial 
    performance of specific items within their inventory.""",
    ...
    'data': [
        ...
        'report/product_profit_report_views.xml',
