...
class ThemeUtils(models.AbstractModel):
    ...
    def _theme_boec_post_copy(self, mod):
        ...
        self.disable_view('website_sale.shop_product_buttons')
        ...
        self.disable_view('website_sale.product_picture_magnify_click')
        self.disable_view('website_sale.variants')
        self.disable_view('website_sale_comparison.product_attributes_body')
        self.disable_view('website_sale.ecom_show_extra_fields')
        self.disable_view('website_sale.product_terms_and_conditions')
        self.disable_view('website_sale.shop_product_buttons')
