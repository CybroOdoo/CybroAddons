...
class PosOrder(models.Model):
    """POS Order model inheritance.

    Automatically triggers the creation and optional completion of
    Manufacturing Orders (MRP) for order lines containing products configured
