...
class ProductTemplate(models.Model):
    """Product Template model inheritance.

    Adds fields to determine if Point of Sale (POS) orders for this product
    should automatically trigger the creation of Manufacturing Orders (MRP),
    and whether those generated orders should be automatically completed.
    """
