...
publicWidget.registry.SolarionTheme = publicWidget.Widget.extend({
    ...
    _initNav: function () {
        ...
        const drawer = this.el.querySelector('#navDrawer');
        if (toggle && drawer) {
            const toggleDrawer = (show) => {
                const isOpen = typeof show === 'boolean' ? show : !drawer.classList.contains('open');
            ...
            const drawerLinks = drawer.querySelectorAll('.nav__links a');
