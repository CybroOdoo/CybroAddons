...
#############################################################################
{
    ...
    'depends': ['website', 'mail', 'html_builder'],
    ...
    'assets': {
        ...
        'website.website_builder_assets': [
            'theme_upshift/static/src/js/video_options.js',
            'theme_upshift/static/src/xml/video_options.xml',
            'theme_upshift/static/src/js/button_options.js',
            'theme_upshift/static/src/xml/button_options.xml',
        ],
    },
    "images": [
