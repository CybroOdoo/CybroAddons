...
class ProductTemplate(models.Model):
    ...
    def _load_pos_data_fields(self, config):
        """Extend PoS data fields to include bundle-related fields."""
        result = super()._load_pos_data_fields(config)
        result += ['is_bundle', 'bundle_contents_info']
        return result

    @api.onchange('bundle_line_ids', 'bundle_line_ids.quantity',
                  'bundle_line_ids.product_id', 'calc_pack_price',
                  'calc_pack_cost', 'is_bundle')
