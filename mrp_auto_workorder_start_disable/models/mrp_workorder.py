...
class MrpWorkorder(models.Model):
    ...
    def action_open_mes(self):
        """Open the MES view and optionally auto-start the work order.

        When the related production has auto-start enabled, this method starts
        the current work order before returning the standard MES action.
        """
        self.ensure_one()
