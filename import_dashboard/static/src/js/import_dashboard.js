...
"use strict";
    ...
    events: {
        ...
        'click .import_sales_pricelist': 'import_sales_pricelist',
        'click .import_inventory': 'import_inventory',
        'click .import_inventory_with_lot': 'import_inventory_with_lot',
    },
    willStart: function(){
    ...
    //For loading the import of attendence form view
        var self = this;
        this.do_action({
    ...
    import_sales_pricelist: function (e) {
        //For loading the import of sales price-list form view
        var self = this;
        this.do_action({
    ...
    import_inventory: function (e) {
        //For loading the import of inventory without lot and serial number form view
        var self = this;
        this.do_action({
    ...
    import_inventory_with_lot: function (e) {
        //For loading the import of inventory with lot and serial number form view
        var self = this;
        this.do_action({
