...
class FleetVehicle(models.Model):
    ...
    def get_tiles_data(self):
        ...
        """
        if self.env.user.has_groups('fleet.fleet_group_manager'):
            flag = 1
            ...
            fleet_model_list = list(set(all_vehicles.mapped("model_id").ids))
            fleet_manufacture_list = list(set(all_vehicles.mapped("model_id.brand_id").ids))
