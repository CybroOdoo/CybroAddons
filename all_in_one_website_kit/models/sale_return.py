...
class SaleReturn(models.Model):
    ...
    def return_confirm(self):
        ...
        if moves:
            ...
            return_pick_action = return_pick_wizard.action_create_returns()
            if return_pick_action and isinstance(return_pick_action, dict) and 'res_id' in return_pick_action:
