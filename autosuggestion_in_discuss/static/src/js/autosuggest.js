odoo.define('autosuggestion_in_discuss.auto_suggest', function (require) {
//Added the automatic suggestion in keydown and keyup function in the class ComposerTextInput
    'use strict';
    const ComposerTextInput = require('mail/static/src/components/composer_text_input/composer_text_input.js');
    var rpc = require('web.rpc');
//    Adding suggestion of message to ComposerTextInput
    Object.assign(ComposerTextInput.prototype, {
//    Keydown function of ComposerTextInput
        _onKeydownTextarea(ev){
            ...
            rpc.query({
                ...
                /*Matching sentences or words are taken from the list */
                    ...
                    var filter_list = data.filter(ard => ard.match(matcher));
                    filter_list.sort();
...
//        Keyup function of ComposerTextInput
      _onKeyupTextarea(ev){
            let autoCompleteTextAreaEl = this.el.querySelector('#autoCompleteText');
            let userTextAreaEl = this.el.querySelector('#userInputText');
            var UserInput = userTextAreaEl.value;
