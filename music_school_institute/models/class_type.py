...
class ClassType(models.Model):
    ...
    def _check_from_and_to_date(self):
        """
        Ensure that the class start date is earlier than or equal to the end date.

        Raises:
            ValidationError: If the from_date is later than the to_date.
        """
    ...
    def action_related_order(self):
        ...
        return {
            ...
            'domain': [('partner_id', 'in', self.student_ids.ids), ('class_id', '=', self.id)],
