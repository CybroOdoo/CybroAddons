...
class ResConfigSettings(models.TransientModel):
    """
     Inherits the 'res.config.settings' model to add configuration fields
     for Sale Order Approval and Minimum Amount. Provides methods to get
     and set these values from the 'ir.config_parameter' model.
     """
