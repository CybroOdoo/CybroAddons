...
class GymMembership(models.Model):
    ...
    def action_extend_membership(self):
        ...
        return {
            ...
            'res_model': 'gym.membership.extend',
            'view_mode': 'form',
            'target': 'new',
            'context': {
    ...
    def _check_and_activate_membership(self):
        """Activate membership when all related invoices are fully paid."""
    ...
    def _compute_paid_amount(self):
        """Compute total paid amount from related invoices."""
        for membership in self:
            total_paid = 0.0
    ...
    def _compute_membership_duration(self):
        """Compute membership duration in days."""
        for rec in self:
    ...
    def _compute_extension_count(self):
        """Compute number of membership extensions."""
        for rec in self:
