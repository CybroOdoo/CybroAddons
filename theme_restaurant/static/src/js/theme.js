        ...
        .then(html => {
            ...
            if (cartProducts.length > 0) {
                cartProducts.forEach(el => {
                    ...
                    const imgEl = el.querySelector('td.td-img img, td.td-img [t-field] img, img.o_image_64_max');
                ...
                const subtotalEl = doc.querySelector('#order_total_untaxed .monetary_field') || doc.querySelector('#order_total .monetary_field') || doc.querySelector('#amount_total_summary');
...
publicWidget.registry.SavoraReservations = publicWidget.Widget.extend({
    ...
    _onToStep4() {
        ...
        const guests = this.$('.sv-res-step.active').text().trim() || '2';
        const data = {
    ...
    _updateReviewData() {
        ...
        this.$('#resReviewGuests, #reviewGuestsVal, #confirmGuestsVal').text(guests + " Guests");
