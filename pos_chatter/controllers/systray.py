...
class SystrayController(http.Controller):
    ...
    @http.route('/pos_systray/message_data', auth='public', type='jsonrpc')
    ...
    @http.route('/pos_systray/chat_message', auth='public', type='jsonrpc')
    ...
    @http.route('/pos_chatter/send_message', auth='public', type='jsonrpc')
