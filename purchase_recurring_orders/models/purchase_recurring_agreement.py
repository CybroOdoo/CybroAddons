...
class PurchaseRecurringAgreement(models.Model):
    ...
    name = fields.Char(string='Sequence Number', index=True, size=32,
                       help="Number of agreement. Keep empty to get the "
                            "number assigned by a sequence.", copy=False,
                       default=_('New'), readonly=True)
    active = fields.Boolean(string='Active', default=True,
                            help='Unchecking this field, quotation for '
                                 'corresponding product is not generated')
    ...
    start_date = fields.Date(string='Start Date', index=True, copy=False,
                             help="Beginning of the agreement. Keep empty to "
    ...
    order_ids = fields.One2many('purchase.order', copy=False, readonly=True,
                                inverse_name='recurring_agreement_id',
                                string='Orders')
    renewal_ids = fields.One2many('agreement.renewal.line', readonly=True,
                                  copy=False, sring='Renewal Lines',
