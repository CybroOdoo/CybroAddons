...
class InstaProfile(models.Model):
    ...
    name = fields.Char(string="Name", readonly=True,
                       help='The name of the Instagram profile')
    access_token = fields.Char("Access Token",
                               help='The access token of instagram')
    username = fields.Char('Username', readonly=True,
                           help='The username of instagram')
    account_id = fields.Char('Account ID', readonly=True,
                             help='Meta Account Id')
    profile_image_url = fields.Binary(attachment=True, help='Instagram Profile')

    def action_fetch(self):
        """This function is for fetching the instagram account:"""
    ...
    def action_get_post(self):
        """ This function is for fetching the instagram post"""
