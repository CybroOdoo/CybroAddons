...
##############################################################################
{
    ...
    'summary': 'This module helps to manage man power supply.',
    'description': """This module automates the process of matching client
    requirements with suitable resources and streamlines the allocation and
    management of manpower, ensuring efficient service delivery.""",
    ...
    'assets': {
        'web.assets_backend': [
            '/manpower_supply_management/static/src/js/dashoard.js',
            ...
            '/manpower_supply_management/static/src/xml/dashoard.xml',
        ],
        'web.assets_frontend': [
