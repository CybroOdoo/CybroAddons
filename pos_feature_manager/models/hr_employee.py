...
class HrEmployee(models.Model):
    ...
    pos_allow_numpad = fields.Boolean(
        string='Allow Numpad',
        default=True,
        help='Allow this employee to use the numeric keypad in POS.'
    )
    ...
    pos_allow_customer_selection = fields.Boolean(
        ...
        default=True,
        help='Allow this employee to select or add customers in POS.'
    )
    pos_allow_plus_minus = fields.Boolean(
        string='Allow +/- Button',
        default=True,
        help='Allow this employee to use the +/- button in POS.'
    )