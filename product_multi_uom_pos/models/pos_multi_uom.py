...
class PosMultiUom(models.Model):
    ...
    def _load_pos_data_fields(self, config_id):
        """ Returns a list of fields required for loading POS data. """
        params = ['product_template_id', 'category_id', 'uom_id', 'price',
                  'uom_name']
        return params

    def _load_pos_data(self, data):
        """Loads POS data based on the provided domain and fields.
            Returns the data and field list."""
        domain = []
