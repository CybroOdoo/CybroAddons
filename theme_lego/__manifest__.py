...
#############################################################################
{
    ...
    'data': [
        ...
        'views/snippets/snippet_map_template.xml',
        'views/snippets/snippet_banner_template.xml',
        'views/snippets/snippet_contact_template.xml',
        'views/snippets/snippet_index_deal_template.xml',
    ],
    'assets': {
        'web.assets_frontend': [
            ...
            "/theme_lego/static/src/xml/deal_product.xml",
            "/theme_lego/static/src/js/deal.js",
            "/theme_lego/static/src/js/subscription.js",
        ],
        'website.assets_editor': [
            "/theme_lego/static/src/xml/website_preview.xml"
        ],
    },
    'images': [
