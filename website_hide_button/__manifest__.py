...
################################################################################
{
    ...
    'version': '14.0.1.0.0',
    'category': 'Website',
    'summary': """This module helps to hide the Product price, Add to Cart 
     button and Quantity buttons in eCommerce shop for guest users""",
    'description': """This application is used to hide the product pricing, 
     Add to Cart button, and quantity selection options for guest users in an 
     eCommerce store, but it is visible to logged-in customers.""",
