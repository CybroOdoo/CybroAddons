...
class SaleOrder(models.Model):
    ...
    booking_date = fields.Date(string='Booking Date',
                               help="The check-in or start date of the booking, set from the customer's "
                                    "selection on the website.")
    booking_date_end = fields.Date(string='Booking Date End',
                                   help="The check-out or end date of the booking. If not set, the booking is "
    ...
    booking_product_id = fields.Many2one('product.template', string='Booking Product',
