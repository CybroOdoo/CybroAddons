...
class TestRestaurantTable(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        floor = cls.env["restaurant.floor"].create({
            "name": "Main Floor",
    ...
    def test_compute_is_show_field_depends_on_reservation_charge_param(self):
        ...
        self.table_1._compute_is_show_field()
        self.assertTrue(self.table_1.is_show_field)

        params.set_param("table_reservation_on_website.reservation_charge", False)
        self.table_1._compute_is_show_field()
        self.assertFalse(self.table_1.is_show_field)
