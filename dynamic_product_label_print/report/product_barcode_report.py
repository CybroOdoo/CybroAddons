...
def _prepare_datas(env, data):
    """
    Change product ids by actual product object to get access
    to fields in xml template
    ...
    if data.get('custom_barcodes'):
        # We expect custom barcodes format as: {product:
        # [(barcode, qty_of_barcode)]}
...
class ReportProductTemplateLabelDynamic(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data):
        ...
        :param docids: the recordset/ record from which the report action is invoked
