...
###############################################################################
{
    ...
    'depends': ['hr', 'point_of_sale', 'mrp', 'web', 'mail'],
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'all_in_one_pos_kit/static/src/time_based_product/css/meal_plan_badge.css',
            'all_in_one_pos_kit/static/src/time_based_product/js/pos_model_load.js',
            'all_in_one_pos_kit/static/src/time_based_product/js/product_card_props.js',
            'all_in_one_pos_kit/static/src/time_based_product/js/pos_planning.js',
            ...
            'all_in_one_pos_kit/static/src/time_based_product/xml/meal_plan_badge.xml',
            'all_in_one_pos_kit/static/src/time_based_product/xml/meal_plan_product_screen.xml',
