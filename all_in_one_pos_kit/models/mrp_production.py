                        ...
                        if bom:
                            ...
                            for bom_line in mrp_order.bom_id.bom_line_ids:
                                list_value.append((0, 0, {
                                    ...
                                    'product_uom_qty': (bom_line.product_qty * mrp_order.product_qty) / bom.product_qty if bom.product_qty else bom_line.product_qty,
                                    'picking_type_id': mrp_order.picking_type_id.id,
                                    'location_id': mrp_order.location_src_id.id,
                                    'location_dest_id': bom_line.product_id.with_company(mrp_order.company_id).property_stock_production.id,
