...
class MealsPlanning(models.Model):
    """By using this model user can specify the time range and pos shop"""
    ...
    def _load_pos_data_fields(self, config_id):
        """Return the list of fields to be loaded into the POS frontend."""
        return ['name', 'menu_product_ids', 'time_from', 'time_to',
                'state', 'pos_ids']

    @api.model
    def _load_pos_data_domain(self, data):
        """Define the domain to filter records loaded into POS (only activated plans)."""
