odoo.define('age_restricted_product_pos.age_restrict', function (require) {
"use strict";
    const Registries = require('point_of_sale.Registries');
    const ProductScreen = require('point_of_sale.ProductScreen');
    var models = require('point_of_sale.models');
    models.load_fields('product.product', 'is_age_restrict');
        //Extending the product screen and on click function of the products in
        //product screen ,it shows warnings as age restricted product,
        //if it is age restricted one.
