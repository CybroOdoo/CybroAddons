...
###############################################################################
{
    ...
    'summary': """Database Restore Manager,Restore Manager,Odoo Database Backup, 
     Automatic Backup, Database Backup, Automatic Backup,Database auto-backup, 
     odoo backup google drive, dropbox, nextcloud, amazon S3, onedrive or 
     remote server, Odoo18""",
