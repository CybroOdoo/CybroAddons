...
publicWidget.registry.LeMobileMenu = publicWidget.Widget.extend({
    ...
    start() {
        ...
        const toggle = document.getElementById("leMobileToggle");
        const menu = document.getElementById("leMobileMenu");
        const close = document.getElementById("leMobileClose");
        const overlay = document.getElementById("leMobileOverlay");
        const openMenu = () => {
        ...
        document.querySelectorAll(".le-nav-menu ul li a, .le-mobile-nav ul li a").forEach(link => {
