...
publicWidget.registry.WinterProduct = publicWidget.Widget.extend({
    ...
    start: function() {
        ...
        return this._super.apply(this, arguments).then(function() {
            ...
            return rpc('/get_winter_product_snippet', {});
        }).then(function(data) {
            if (data) {
                self.$el.empty().html(
                    renderToElement('theme_shopping.winter_product_carousel_snippet', { products: data })
                );
                self._initCarousel();
            }
        });
    ...
    _clearContent() {
        const $area = this.$el.find('.winter_products_carousel');
