        ...
        for line in self:
            ...
            if taxes:
                taxes = taxes.compute_all(price, currency, line.qty,
                                          ...
                                          partner=line.order_id.partner_i
                                                  or False)
