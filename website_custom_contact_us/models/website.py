...
class Website(models.Model):
    """ Inherited model Website to add company details in contact us page"""
    _inherit = 'website'

    # Adding the necessary fields for Website contact us
    company = fields.Boolean("Company Name",
                             help='If it is true it will show company name '
                                  'on website',
                             default=False)
    ...
    vat = fields.Boolean("VAT", help='If it is true it will show tax id '
                                     'on website', default=False)
    address_in_online = fields.Boolean("Address in one line",
                                       help='If it is true it will show '
                                            'address in one line on website',
                                       default=False)
    ...
    country_flag = fields.Boolean("Country Flag",
                                  help='If it is true it will show country '
                                       'flag on website',
                                  default=False)
    ...
    social_facebook = fields.Char(string="Facebook",
                                  ...
                                  readonly=False, help='Facebook Account')
    ...
    linked_in = fields.Boolean("LinkedIn", help='If it is true it will'
                                                'show twitter on website',
                               default=False)
    social_linked_in = fields.Char(string="Linked In",
    ...
    git_hub = fields.Boolean("GitHub", help='If it is true it will '
                                            'show twitter on website',
                             default=False)
    social_git_hub = fields.Char(string="Git Hub",
