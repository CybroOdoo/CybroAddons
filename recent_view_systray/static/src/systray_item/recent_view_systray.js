...
export class RecentViewSystray extends Component {
    ...
    get limit() {
        return this.user.context.history_limit || session.history_limit || 15;
    }
    ...
    async translateActions(actionIds) {
        ...
        try {
            ...
            const isEnglish = (this.user.context.lang || session.user_context?.lang || "en").startsWith("en");
    ...
    updateRecentViews() {
        ...
        if (breadcrumbItems.length > 0) {
            ...
            // In Odoo 17 titles are prefixed as "Odoo - ActionName",
            // so prefer the clean controller.displayName directly.
            displayName = controller.displayName || document.title;
        }
