...
class EmployeePromotion(models.Model):
    ...
    description = fields.Text(string='Description',
                              help='Description of the promotion')
    ...
    def _onchange_employee_id(self):
        """This method is called when the employee_id field is changed. It
        searches for an open HR contract history record for the selected
        employee and sets the contract_id and job_salary fields based on the
        corresponding values in the contract. If no open contract is found, the
    ...
    def write(self, vals):
        ...
        greater than the current job salary. If the new salary is greater, raise
        a UserError with a warning message."""
