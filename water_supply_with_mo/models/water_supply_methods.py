...
class WaterSupplyMethods(models.Model):
    ...
    code = fields.Char(string='Internal Code', help='Code of the supply method', required=True)
    supply_name = fields.Char(string='Supply Name', help='Supply name', required=True)
