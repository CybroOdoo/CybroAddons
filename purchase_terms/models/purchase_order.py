...
class PurchaseOrder(models.Model):
    ...
    def _default_notes(self):
        """Fetch the default purchase terms from the company's settings.
        Default purchase terms set in the company configuration."""
        return self.env.company.purchase_terms

    notes = fields.Html(string='Terms and Conditions', default=_default_notes,
                        help="Terms and Conditions of the Purchase Order")
