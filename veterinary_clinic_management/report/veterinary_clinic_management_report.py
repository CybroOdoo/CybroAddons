...
class VeterinaryClinicManagementReport(models.AbstractModel):
    """
    Abstract model for generating veterinary reports.

    This class inherits from `models.AbstractModel` to provide a custom report
    for the veterinary clinic management module. It defines the report template and
    ...
    """
    _name = "report.veterinary_clinic_management.veterinary_report_template"
