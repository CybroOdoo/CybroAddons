...
#############################################################################
{
    ...
    'depends': ['loyalty', 'pos_loyalty', 'sale','point_of_sale'],
    'data': [
    ...
    'assets': {
        ...
        'point_of_sale._assets_pos': [
            ...
            'advanced_loyalty_management/static/src/app/loyalty_program/pos_loyalty.js',
            'advanced_loyalty_management/static/src/app/loyalty_program/pos_loyalty_popup.xml',

            'advanced_loyalty_management/static/src/js/pos_reward_button.js',
            'advanced_loyalty_management/static/src/app/loyalty_program/pos_reward_redeem_popup.js',
            ...
            'advanced_loyalty_management/static/src/xml/select_partner_button_fix.xml',
            'advanced_loyalty_management/static/src/xml/payment_screen_partner_fix.xml',

            'advanced_loyalty_management/static/src/app/loyalty_program/pos_redeem_reward_popup.xml',
