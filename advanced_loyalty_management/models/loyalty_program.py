...
class LoyaltyProgram(models.Model):
    ...
    def convert_loyalty(self, pid, cid, loyalty, partner_id):
        ...
        if int(cid[0]) < 0:
            ...
            loyalty_card.points += loyalty_points

        # Add to loyalty history
        self.env['loyalty.history'].create({
            'card_id': loyalty_card.id,
            'description': 'Change converted to loyalty points',
            'issued': loyalty_points,
            'used': 0,
        })
