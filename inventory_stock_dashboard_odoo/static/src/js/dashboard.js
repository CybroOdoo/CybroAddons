...
class Dashboard extends owl.Component{
    ...
    // Helper method to destroy and recreate charts
    ...
    async render_top_product_bar_graph(){
        ...
        await this.orm.call("stock.move", "get_the_top_products", []
            ...
            // CHANGE: var myChart → this.charts.topProduct
            this.charts.topProduct = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: products,
                    datasets: [{
    ...
    async render_stock_moves(){
        this.orm.call("stock.move", "get_stock_moves", []
            ...
            // CHANGE THIS LINE: Don't use 'var myChart', use 'this.charts.stockMoves'
            this.charts.stockMoves = new Chart(ctx, {
                type: 'pie',
                data: {
                    labels: name,
                    datasets: [{
    ...
    onchange_top_product_selection(events){
        ...
        // Destroy the existing chart ONCE before all options
        this.destroyChart('topProduct');
        ...
        else if (option == 'top_last_30_days'){
        ...
        else if (option == 'top_last_3_month'){
    ...
    async onchange_stock_moves_selection(events){
        ...
        // Stock moves in current month
            ...
            this.orm.call("stock.move", "this_month",[option]
                ...
                // CHANGE: var myChart → this.charts.stockMoves
                this.charts.stockMoves = new Chart(ctx, {
                    type: 'pie',
                    data: {
                        labels: name,
