...
#    Author: Saneen K (Contact : odoo@cybrosys.com)
#
...
class StockMove(models.Model):
    """Inheriting the stock move model for checking and updating the
    recipients for delivering the product"""
    _inherit = 'stock.move'
    ...
    def _assign_picking(self):
        ...
        for group, moves in grouped_moves:
            ...
            new_picking = False
            # Could pass the arguments contained in group but, they are
            # the same
            ...
            if picking:
                ...
                if (sale_order.delivery_split and
                        sale_order.order_line.recipient_id):
                    for move in moves:
