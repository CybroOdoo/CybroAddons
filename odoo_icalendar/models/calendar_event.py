...
class Meeting(models.Model):
    ...
    def action_send_ics(self):
        ...
        attachment_values = {
            'name': 'Event.ics',
            'type': 'binary',
            'datas': base64.b64encode(self._get_ics_file().get(self.id)),
        ...
        email_template = self.env.ref(
            'odoo_icalendar.event_ics_email_template')
        email_values = {
            'email_to': ', '.join(
    ...
    def action_send_attendee_ics_file(self):
        ...
        def ics_datetime(idate, allday=False):
            """Format a date and time as an iCalendar-compatible string.
               ...
               (default is False).
               :type allday: bool
               :return: The formatted date and time as a string in the
                iCalendar format.
        ...
        for attendee_id, cal in attendee_events.items():
            ...
            attachment_values = {
                'name': 'All_Events.ics',
                'type': 'binary',
                'datas': base64.b64encode(cal.serialize().encode('utf-8')),
                'mimetype': 'text/calendar',
                'res_model': 'calendar.event',
                'res_id': attendee.id,
            }
