/** @odoo-module **/
    ...
    // Event handl  er for the click event on elements with the design_save class
    ...
    _addProductDesign: function(ev){
        count++;
        const productDesignBody = document.querySelector('.product_design_body');
        if (count%2 == 0){
           productDesignBody.classList.add("d-none");
        }
        else{
            productDesignBody.classList.remove("d-none");
        }
    },
});
