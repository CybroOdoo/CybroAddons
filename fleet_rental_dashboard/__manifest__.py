...
###############################################################################
{
    ...
    'description': """This module enhances the fleet rental management system
    by offering a centralized view of crucial metrics and analytics.""",
    ...
    'assets': {
        ...
        'web.qunit_suite_tests': [
            'fleet_rental_dashboard/static/tests/dashboard_tests.js',
        ],
    },
