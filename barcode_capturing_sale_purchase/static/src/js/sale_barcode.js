...
// Extends FormController for rendering the Sale order form with barcode scanning functionality.
export class ComSaleOrderRender extends FormController {
   setup() {
...
ComSaleOrderRender.template = "barcode_capturing_sale_purchase.sale_scanner";
