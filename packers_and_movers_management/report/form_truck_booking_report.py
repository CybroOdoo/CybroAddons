...
class TruckFormReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids):
        ...
        query = """select tb.reference_no,pr.name,fv.name as truck,gt.name
         as goods,tb.from_location,tb.to_location,tb.distance,tb.weight,
         tb.unit,amount,tb.date,tb.state from truck_booking as tb
