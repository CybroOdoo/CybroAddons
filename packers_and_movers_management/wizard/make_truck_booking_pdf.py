...
class MakeTruckBookingPdf(models.TransientModel):
    ...
    def action_report_truck_booking(self):
        ...
        query = """select pr.name,fv.name as truck,gt.name as goods,
                ...
                tb.weight,tb.unit,amount,tb.date,
                tb.state from truck_booking as tb
        ...
        return (self.env.ref
                ('packers_and_movers_management.action_report_booking').
