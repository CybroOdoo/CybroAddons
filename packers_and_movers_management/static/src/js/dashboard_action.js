...
var CustomDashBoard = AbstractAction.extend({// Extended abstract class to create dashboard
    ...
    render_truck:function(){//Function to add booking chart on the basis of truck
        rpc.query({
            model: "truck.booking",
    ...
    render_distance:function(){//Function to add total distance chart on the basis of customer and truck
        rpc.query({
            model: "truck.booking",
            method: "get_distance",
        }).then(function (result) {
    ...
    render_weight:function(){//Function to add total goods weight chart on the basis of customer and truck
        rpc.query({
            model: "truck.booking",
            method: "get_weight",
        }).then(function (result) {
