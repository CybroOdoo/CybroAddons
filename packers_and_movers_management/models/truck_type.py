...
class TruckType(models.Model):
    ...
    name = fields.Char(string='Truck Type', required=True, help='Truck type name')
    ...
    capacity = fields.Float(string='House Hold Capacity', required=True, help='Suitable for house size')
    weight = fields.Float(string='Max Weight', required=True, help='Max Load of container')
