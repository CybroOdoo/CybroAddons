...
#############################################################################
{
    ...
    'summary': """Users can reserve trucks online with the help of the Packers
     & Movers Management module.""",
    ...
    'assets': {
        ...
        'web.assets_qweb': [
            'packers_and_movers_management/static/src/xml/'
