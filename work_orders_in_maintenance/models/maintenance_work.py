...
class MaintenanceWork(models.Model):
    ...
    def create(self, vals_list):
        ...
        :param vals_list: List of dictionaries of values for creating the records.
        :return: Newly created records.
        """
        for vals in vals_list:
            if vals.get("name", "New") == "New":
                vals["name"] = self.env["ir.sequence"].next_by_code("work.order.id") or "New"
        res = super(MaintenanceWork, self).create(vals_list)
        return res
