...
class TestResPartner(TransactionCase):
    """Test case for computing and verifying customer health scores under different ticket conditions."""

    def setUp(self):
        """Set up test models, a default partner/support team, and custom ticket stages."""
