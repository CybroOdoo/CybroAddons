...
#############################################################################
{
    ...
    "description": """Modern and customizable backend theme for Odoo 19 with dynamic colors,
enhanced navigation, and an improved user experience""",
    "summary": """Infinito Backend Theme for Odoo 19 provides a modern and flexible interface
