...
const NewTools = {
    ...
    'property': [
        ...
        {'name': 'animation-duration', 'type': 'range', 'unit': 's', 'min': 0, 'max': 60, 'alt': ['-webkit-']},
        {
            ...
            'type': 'select',
            'options': ['none', 'forwards', 'backwards', 'both', 'initial', 'inherit'],
            'alt': ['-webkit-']
        },
        {
        ...
        {'name': 'animation-name', 'type': 'input', 'alt': ['-webkit-']},
        {
            ...
            'type': 'select',
            'options': ['paused', 'running', 'initial', 'inherit'],
            'alt': ['-webkit-']
        },
        {
            'name': 'animation-timing-function',
            'type': 'select',
            'options': ['linear', 'ease', 'ease-in', 'ease-out', 'ease-in-out', 'initial', 'inherit'],
            'alt': ['-webkit-']
        },
        {
        ...
        {'name': 'box-shadow', 'type': 'input', 'alt': []},
        {
            'name': 'box-sizing',
            'type': 'select',
            'options': ['content-box', 'padding-box', 'border-box', 'initial', 'inherit'],
            'alt': []
        },
        ...
        {'name': 'column-count', 'type': 'range', 'unit': false, 'min': 0, 'max': 10, 'alt': ['-webkit-', '-moz-']},
        {
            'name': 'column-fill',
            'type': 'select',
            'options': ['auto', 'balance', 'initial', 'inherit'],
            'alt': ['-webkit-', '-moz-']
        },
        ...
        {'name': 'column-rule-width', 'type': 'range', 'unit': 'px', 'min': 0, 'max': 25, 'alt': ['-webkit-', '-moz-']},
        {
            'name': 'column-span',
            'type': 'select',
            'options': ['none', 'all', 'initial', 'inherit'],
            'alt': ['-webkit-', '-moz-']
        },
        ...
        {'name': 'font-size-adjust', 'type': 'range', 'unit': false, 'min': 0, 'max': 10, 'alt': []},
        {
            'name': 'font-stretch',
            'type': 'select',
            'options': ['normal', 'ultra-condensed', 'extra-condensed', 'condensed', 'semi-condensed', 'semi-expanded', 'expanded', 'extra-expanded', 'ultra-expanded', 'initial', 'inherit'],
            'alt': []
        },
        ...
        {'name': 'line-height', 'type': 'range', 'unit': false, 'min': 0, 'max': 10, 'alt': []},
        {
            ...
            'type': 'select',
            'options': ['inside', 'outside', 'initial', 'inherit'],
            'alt': []
        },
        {
            'name': 'list-style-type',
            'type': 'select',
            'options': ['disc', 'circle', 'square', 'decimal', 'decimal-leading-zero', 'lower-roman', 'upper-roman', 'lower-greek', 'lower-latin', 'upper-latin', 'armenian', 'georgian', 'lower-alpha', 'upper-alpha', 'none', 'inherit'],
            'alt': []
        },
        ...
        {'name': 'outline-offset', 'type': 'range', 'unit': 'px', 'min': 0, 'max': 500, 'alt': []},
        {
            'name': 'outline-style',
            'type': 'select',
            'options': ['none', 'dotted', 'dashed', 'solid', 'double', 'groove', 'ridge', 'inset', 'outset', 'initial', 'inherit'],
            'alt': []
        },
        ...
        {'name': 'padding-top', 'type': 'range', 'unit': 'px', 'min': 0, 'max': 500, 'alt': []},
        {
            ...
            'type': 'select',
            'options': ['auto', 'always', 'avoid', 'left', 'right', 'inherit'],
            'alt': []
        },
        {
        ...
        {'name': 'text-indent', 'type': 'range', 'unit': 'px', 'min': 0, 'max': 20, 'alt': []},
        {
            'name': 'text-justify',
            'type': 'select',
            'options': ['auto', 'none', 'inter-word', 'distribute', 'initial', 'inherit'],
            'alt': []
        },
        {
            'name': 'text-overflow',
            'type': 'select',
            'options': ['clip', 'ellipsis', 'string', 'initial', 'inherit'],
            'alt': []
        },
        {'name': 'text-shadow', 'type': 'input', 'alt': []},
        {
            'name': 'text-transform',
            'type': 'select',
            'options': ['capitalize', 'uppercase', 'lowercase', 'none', 'inherit'],
            'alt': []
        },
        ...
        {'name': 'transform', 'type': 'input', 'alt': ['-webkit-', '-moz-', '-ms-']},
        {
            ...
            'type': 'select',
            'options': ['x-position', 'y-position', 'z-position', 'initial', 'inherit'],
            'alt': ['-webkit-', '-moz-', '-ms-']
        },
        {
            'name': 'transform-style',
            'type': 'select',
            'options': ['flat', 'preserve-3d', 'initial', 'inherit'],
            'alt': ['-webkit-', '-moz-', '-ms-']
        },
        ...
        {'name': 'width', 'type': 'range', 'unit': 'px', 'min': 0, 'max': 500, 'alt': []},
        {
            'name': 'word-break',
            'type': 'select',
            'options': ['normal', 'break-all', 'keep - all', 'initial', 'inherit'],
            'alt': []
        },
