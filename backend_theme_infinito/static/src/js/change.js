...
"use strict";
    ...
    var NewTools = {
        'property': [
            ...
            // {'name': 'background-image', 'type': 'upload', 'alt': []},
            ...
            // {'name': 'border-image-outset', 'type': 'range', 'unit': 'px', 'min': 0, 'max': 60, 'alt': []},
            // {'name': 'border-image-repeat', 'type': 'select', 'options': ['stretch', 'repeat', 'round', 'space', 'initial', 'inherit'], 'alt': []},
            // {'name': 'border-image-slice',  'type': 'range', 'unit': false, 'min': 0, 'max': 60, 'alt': []},
            // {'name': 'border-image-source', 'type': 'upload', 'alt': []},
            // {'name': 'border-image-width', 'type': 'range', 'unit': 'px', 'min': 0, 'max': 10, 'alt': []},
            ...
            // {'name': 'list-style-image', 'type': 'upload', 'alt': []},
            ...
            // {'name': 'vertical-align', 'type': 'select', 'options': ['baseline', 'sub', 'super', 'top', 'text-top', 'middle', 'bottom', 'text-bottom', 'inherit'], 'alt': []},
