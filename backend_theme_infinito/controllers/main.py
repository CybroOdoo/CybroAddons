...
class ThemeStudio(http.Controller):
    ...
    def get_presets(self):
        ...
        Example:
            ...
            ```
        """
        presets_path = file_path('backend_theme_infinito/static/src/json/presets.json')
        file = open(presets_path, 'r')
