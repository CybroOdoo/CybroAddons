odoo.define('invoice_mini_dashboard.invoice', function(require) {
    "use strict";
    /**
    ...
    var QWeb = core.qweb;
    // Add mock of method 'retrieve_out_invoice_dashboard' in SampleServer,so
    // that we can have the sample data in empty invoice list view
    let dashboardValues;
    ...
    view_registry.add('invoice_dashboard_list', InvoiceListDashboardView);
    return {
