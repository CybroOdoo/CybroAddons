...
###########################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'invoice_mini_dashboard/static/src/views/invoice_list_view.js',
            'invoice_mini_dashboard/static/src/views/invoice_list_view_templates.xml',
            ...
            'invoice_mini_dashboard/static/src/views/invoice_bill_list_view.js',
            'invoice_mini_dashboard/static/src/views/invoice_bill_list_view_templates.xml',
        ],
    },
