...
################################################################################
{
    ...
    'assets': {
        'website.website_builder_assets': [
            'dynamic_image_hotspot/static/src/js/image_hotspot_plugin.js',
            'dynamic_image_hotspot/static/src/xml/image_hotspot_option.xml',
        ],
        'web.assets_frontend': [
            'dynamic_image_hotspot/static/src/js/frontend.js',
