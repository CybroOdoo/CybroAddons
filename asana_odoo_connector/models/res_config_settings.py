...
def action_notify(success):
    """ Method used to notify whether the connection to the asana is
    successful or not. """
    notification = {
...
def action_import_project_stages(project_gid, api_client):
    """ Method used to import the project stages from asana to odoo """
...
class ResConfigSettings(models.TransientModel):
    ...
    def action_test_asana(self):
        """ Method used to test the connection from odoo to asana """
    ...
    def action_import_projects(self):
        """ Method used to import the project from asana to odoo """
    ...
    def create_project(self, items, app_token):
        """ Method used to create the project from Asana to Odoo """
        configuration = asana.Configuration()
    ...
    def action_import_tasks(self, api_client, section_data, project_id):
        """ Method used to import tasks from the asana to odoo """
