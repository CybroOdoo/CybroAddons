...
class ProjectProject(models.Model):
    """ Inherits the model project.project to add extra fields and
    functionalities for the working of the odoo to asana import and export. """
    ...
    def action_export_to_asana(self):
        """ Method used to export the data in the odoo to asana """
    ...
    def export_project(self, items, workspace_gid):
        """ Method used to export the data from Odoo to Asana """
