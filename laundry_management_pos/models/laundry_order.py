...
#
#    This program is distrRisvanaibuted in the hope that it will be useful,
...
class LaundryOrderLine(models.Model):
    """ This class is inherited for a model laundry_order_line.
            It contains fields and the functions for the model

        Methods:
            _compute_price_tax(self):
                Action performs to compute the subtotal amounts of the
                LaundryOrder line.
    """
