...
#############################################################################
{
    ...
    'description': """This module is an application for Vehicle Rental System 
    which helps in managing the rental of vehicles like car,van,bike, jeep etc.
    It manages fleet/vehicle property by extending the basic fleet module of 
    Odoo.Currently fleet module does not have any connection with accounting 
    module.But in this module, we integrate the module with accounting also.""",
    ...
    'data': [
        ...
        'views/car_rental_checklist_views.xml',
