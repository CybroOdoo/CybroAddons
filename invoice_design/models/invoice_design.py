...
class InvoiceDesign(models.Model):
    ...
    invoice_template = fields.Text(
        string='Invoice XML',
        help='Add your customised invoice design here. Make sure that you add'
             ' code inside <div> tag. Note: You can access data of invoice'
             ' using name "invoice", ie, "invoice.name" will give you the name'
             ' of invoice ',
             default='<div>'
                     '....Enter your code here...'
                     '</div>')
    view_id = fields.Many2one(
        'ir.ui.view', string="View",
        help="A record will be created in ir.ui.view on creating a record in"
             " invoice design. It's id is stored in this field")
