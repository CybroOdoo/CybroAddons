...
class RecommendationController(http.Controller):
    """Controller for handling product recommendations in user sessions"""

    @http.route('/recommendation/session/get', type='jsonrpc', auth='user', methods=['POST'])
    ...
    @http.route('/recommendation/session/save', type='jsonrpc', auth='user', methods=['POST'])
