    ...
    def get_xlsx_report(self, data, response, report_data):
        ...
        if filters.get('report_type') == 'report_by_categories':
            ...
            for rec_data in report_data_main:
                ...
                sheet.write(row, col + 1, (rec_data.get('name', {}).get('en_US') if isinstance(rec_data.get('name'), dict) else rec_data.get('name')), txt_l)
        ...
        if filters.get('report_type') == 'report_by_warehouse':
            ...
            for rec_data in report_data_main:
                ...
                sheet.write(row, col + 4, (rec_data.get('route', {}).get('en_US') if isinstance(rec_data.get('route'), dict) else rec_data.get('route')), txt_l)
