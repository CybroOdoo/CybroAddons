/** Inventory dashboard */
odoo.define("all_in_one_inventory_kit.inventory_dashboard", function (require) {
    "use strict";
    ...
    //    tile late status onclick
        onclick_late_status: function(f) {
            ...
            this.do_action({
                ...
                view_mode: 'tree,form,calendar',
                views: [[false, 'list'],[false, 'form']],
                domain: [['picking_type_id', '=', id],['state', 'in', ['assigned', 'waiting', 'confirmed']],'|',['scheduled_date', '<=', moment().format('YYYY-MM-DD')],['date_deadline', '<=', moment().format('YYYY-MM-DD')],],
                target: 'current',
            }, options)
        },
