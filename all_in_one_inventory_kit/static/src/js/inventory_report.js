...
odoo.define('all_in_one_inventory_kit.inventory_report', function(require) {
   'use strict';
   ...
   var InventoryReport = AbstractAction.extend({
      ...
      /** Click function of calender icon */
