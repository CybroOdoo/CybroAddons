...
#############################################################################
{
    ...
    'assets': {
        ...
        'web.assets_unit_tests': [
            ...
            'pos_restrict_product_stock/static/src/js/OrderScreen.js',
            'pos_restrict_product_stock/static/src/js/ProductConfiguratorPopup.js',
            'pos_restrict_product_stock/static/tests/unit/product_screen.test.js',
            'pos_restrict_product_stock/static/tests/unit/order_screen.test.js',
            'pos_restrict_product_stock/static/tests/unit/product_configurator_popup.test.js',
        ],
    },
