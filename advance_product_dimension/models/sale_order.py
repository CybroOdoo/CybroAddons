...
class SaleOrder(models.Model):
    """Extend sale orders so tax totals reflect dimension-based pricing."""
    _inherit = 'sale.order'
    ...
    def _compute_tax_totals(self):
        """
        Compute tax totals for sale orders, ensuring dimension-based products are included correctly.
        """
        for order in self:
