...
#############################################################################
{
    ...
    'description': """
Manage inward, outward and internal gate passes with security checks, vehicle tracking
and integration with stock pickings, sale orders and purchase orders.
    """,
