...
class BulkPartnerImageImport(models.TransientModel):
    ...
    file = fields.Binary(
        "CSV File", required=True, help="Upload a UTF-8 encoded CSV file containing partner names and image URLs.")
    ...
    def action_import_images(self):
        ...
        try:
            ...
            raise UserError("Invalid file format. Please upload a valid CSV file (UTF-8 encoded).")
