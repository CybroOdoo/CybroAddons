    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            ...
            if product_ids:
                ...
                for line_vals in vals.get('lines'):
                    ...
                    if product_id:
                        ...
                        if product.prepair_time_minutes:
                            total_prepare_time += product.prepair_time_minutes * qty

                vals['avg_prepare_time'] = total_prepare_time
