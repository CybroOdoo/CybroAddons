...
#############################################################################
{
    ...
    'summary': "Theme Kids Care is a kids-focused eCommerce "
               "website theme for Odoo 19 with custom snippets and enhanced product layouts.",
    'description': "Theme Kids Care is a responsive eCommerce theme for Odoo 19 "
    ...
    'depends': ['website_blog', 'website_sale', 'website_sale_stock_renting', 'website_sale_wishlist'],
    'data': [
        ...
        "views/snippets/related_products_snippet.xml",
        "views/snippets/skincare_products_snippet.xml",
        "views/shop.xml",
        "views/homepage.xml",
    ],
    'assets': {
        'web.assets_frontend': [
            ...
            "theme_kids_care/static/src/js/product_snippets.js",
            "theme_kids_care/static/src/js/product_showcase.js",
            "theme_kids_care/static/src/js/wishlist_toggle.js",
        ],
    },
