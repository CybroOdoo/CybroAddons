...
whenReady(() => {
    ...
    const carousels = document.querySelectorAll(
        ...
        '.section-best-sellers .owl-carousel, ' +
        '.section-skincare-products .owl-carousel, ' +
        '.thred-carousel, ' +
        '.blog-carousel, ' +
    ...
    carousels.forEach((carousel) => {
        ...
        const getSlidesPerView = () => {
            ...
            if (carousel.closest('.section-all-the-snekers') || 
                carousel.closest('.section-best-sellers') || 
                carousel.closest('.section-skincare-products')) {
                if (w < 600) return 1;
                return 2;
            }
