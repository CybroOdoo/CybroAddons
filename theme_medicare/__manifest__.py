...
#############################################################################
{
    ...
    'description': 'Theme Medicare is a premium, world-class healthcare theme for Odoo designed specifically for hospitals, clinics, and medical professionals. It features beautifully crafted snippets for departments, doctor profiles, patient services, and emergency contacts, providing a fully responsive and dynamic web presence for your healthcare institution.',
    'sequence': 110,
