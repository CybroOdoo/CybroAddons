...
class ContractsController(http.Controller):
    ...
    def action_print_report(self, contract_id):
        ...
        try:
            contract = request.env['subscription.contracts'].browse(contract_id)
            ...
            report = request.env.ref('sales_contract_and_recurring_invoices.action_report_subscription_contracts')
            ...
            if not pdf_content:
                raise ValueError("PDF report generation failed - empty content")
