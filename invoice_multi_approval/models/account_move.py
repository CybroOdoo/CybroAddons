...
class AccountMove(models.Model):
    ...
    def _onchange_partner_id(self):
        ...
        approval_managers = self.env.ref(
            'invoice_multi_approval.group_approve_manager'
        ).user_ids
    ...
    def _compute_document_fully_approved(self):
        ...
        for rec in self:
            ...
            approval_managers =  self.env.ref('invoice_multi_approval.group_approve_manager').user_ids.ids
