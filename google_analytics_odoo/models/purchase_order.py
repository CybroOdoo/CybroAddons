...
#
#############################################################################
"""This module extends the purchase order to track analytics."""
import requests
from odoo import models


class PurchaseOrder(models.Model):
    """Extends the class  Purchase order by adding
        additional analytics tracking upon posting an invoice."""
    _inherit = 'purchase.order'

    def button_confirm(self):
        """Supering the function to send analytics data of the purchase order.
              :return: Result of confirming  the purchase order."""
