...
class ProjectTask(models.Model):
    ...
    is_announcement_send = fields.Boolean(string="Send Email",
                                       help="Enable to send announcement "
                                            "through email")
    ...
    def get_pending_tasks(self, project_id):
        ...
        view mode. :param project_id: The ID of the project to filter tasks
        by. :return: A dictionary representing an action to open the project
        tasks.
        """
