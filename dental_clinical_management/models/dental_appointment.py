...
class DentalAppointment(models.Model):
    ...
    doctor_id = fields.Many2one('hr.employee', string="Doctor",
                                required=True, help="Name the of the doctor",
    ...
    shift_id = fields.Many2one('dental.time.shift',
                               string="Booking Time", help="Choose the shift",
    ...
    reason = fields.Text(string="Please describe the reason",
                         help="Just explain about the reason to take doctor "
                              "appointment")
    state = fields.Selection([('draft', 'Draft'), ('new', 'New Appointment'),
                              ('done', 'Prescribed'), ('cancel', 'Cancel')],
                             default="draft", string="State", help="State of "
                                                                   "the appointment")
    ...
    def create(self, vals_list):
        ...
        res = super(DentalAppointment, self).create(vals_list)

        # Set state to 'new' for all created records
