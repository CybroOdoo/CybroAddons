...
class QuickViewWebsiteSale(WebsiteSale):
    ...
    @http.route('/c_quick_view/get_quick_view_html', type='jsonrpc',
                auth='public', website=True)
    def get_quick_view_html(self, category='', **kwargs):
