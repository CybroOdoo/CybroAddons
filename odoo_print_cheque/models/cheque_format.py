...
class ChequeFormat(models.Model):
    ...
    is_print_cheque_number = fields.Boolean(string='Print Cheque Number',
    ...
    is_date_remove_slashes = fields.Boolean(string="Remove Slashes",
    ...
    amount_word_ls = fields.Float(string="Amount in Words Letter Spacing",
                                  help="Spacing between characters in the "
                                       "amount in words.")
    is_print_currency = fields.Boolean(string="Print Currency Symbol",
    ...
    def action_print_test(self):
        ...
        data = {
            ...
            'is_print_cheque_number': self.is_print_cheque_number,
            ...
            'is_print_currency': self.is_print_currency,
            'currency_symbol': self.env.company.currency_id.symbol,
            'is_date_remove_slashes': self.is_date_remove_slashes
        }
        return self.env.ref(
