...
import { Component, useState, useRef, onWillUpdateProps, onMounted } from "@odoo/owl";
...
export class DragAndDropBinaryField extends Component {
    ...
    setup() {
        ...
        this.rawCacheKey = this.props.record.data.write_date;
         this.dropzone = useRef("image_picker");
        this.droptarget = useRef("drop_target");
        this.dropinput = useRef("inputFile");
        this.dropimg = useRef("image_preview");
//        this.remover = useRef("remove_current_image");
        this.image_url = null;
    ...
    setupDragAndDrop() {
        const dropzone = this.dropzone.el;
        const droptarget = this.droptarget.el;
        const dropimg = this.dropimg.el;
        const inputFile = this.inputFile.el;
        if (dropzone) {
            dropzone.addEventListener('dragover', (e) => {
                e.preventDefault();
                droptarget?.classList.add('dropping');
            });
            ...
            dropzone.addEventListener('drop', (e) => {
                ...
                if (file) {
                    ...
                    reader.onload = (event) => {
                        ...
                        inputFile.value = event.target.result;
