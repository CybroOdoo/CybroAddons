...
class ModuleActivity(models.Model):
    """
    Model to store and manage the history of module activation activities
    such as installation, uninstallation, and upgrades.
    """
    ...
    name = fields.Char(string="Module Name",
                       related="modules_id.display_name",
...
class InstalledHistory(models.Model):
    """
    Model to store specific details of each module installation event,
    including the user responsible and the timestamp.
    """
...
class UninstalledHistory(models.Model):
    """
    Model to store specific details of each module uninstallation event,
    tracking who performed the action and when.
    """
...
class UpgradeHistory(models.Model):
    """
    Model to store specific details of each module upgrade event,
    recording the upgrade timestamp and the responsible user.
    """
