...
class XLSXReportController(http.Controller):
    ...
    The route '/day_xlsx_reports' accepts POST requests and returns an XLSX report
    based on the provided model, options, output format, and report name.
    """
    @http.route('/day_xlsx_reports', type='http',
