...
################################################################################
{
    ...
    'description': """View of my account in portal view is changed to dashboard view for better user experience""",
    'author': 'Cybrosys Techno Solutions',
    'company': 'Cybrosys Techno Solutions',
    'maintainer': 'Cybrosys Techno Solutions',
    'website': "https://www.cybrosys.com",
    'depends': ['base', 'sale', 'project', 'crm', 'purchase', 'website','web'],
    'data': [
