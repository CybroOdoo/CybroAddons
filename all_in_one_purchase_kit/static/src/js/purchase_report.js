...
var PurchaseReport = AbstractAction.extend({
    contentTemplate: 'PurchaseReport',
    events: {
   ...
   /**
    ...
    apply_filter: function() {
        self = this;
        self.$el.find('.no_data').hide();
        self.initial_render = false;
        var filter_data_selected = {};
        console.log(filter_data_selected,"hiiiiiiiii")
        ...
        console.log(filter_data_selected,"hissss")
        rpc.query({
            model: 'dynamic.purchase.report',
            method: 'write',
            args: [
