...
class ProfitLossReport(models.TransientModel):
    ...
    def action_button_to_print_pdf(self):
        ...
        query = f"""
        select account_account.code,account_account.name ->> 'en_US' ,
        CONCAT(account_account.code, ' - ',account_account.name ->> 'en_US' ) 
        ...
        query += (
            "group by account_account.code,account_account.name ->> 'en_US' ,"
        ...
        select account_account.code,account_account.name ->> 'en_US' ,
        CONCAT(account_account.code, ' - ', account_account.name ->> 'en_US' ) AS 
