...
class Stock3DView(http.Controller):
    ...
    @http.route('/3Dstock/warehouse', type='jsonrpc', auth='public')
    ...
    @http.route('/3Dstock/data', type='jsonrpc', auth='public')
    ...
    @http.route('/3Dstock/data/quantity', type='jsonrpc', auth='public')
    ...
    @http.route('/3Dstock/data/product', type='jsonrpc', auth='public')
    ...
    @http.route('/3Dstock/data/standalone', type='jsonrpc', auth='public')
