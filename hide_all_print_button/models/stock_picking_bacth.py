...
class StockPickingBatch(models.Model):
    """Class for inherited model stock.picking.batch
    Methods:
        fields_view_get(self, view_type, options=None):
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False,
        ...
        res = super(StockPickingBatch, self).fields_view_get(
            view_id=view_id, view_type=view_type, toolbar=toolbar,
            submenu=submenu)
        if ((view_type in ['tree', 'form'] and self.env.user.has_group(
            'hide_all_print_button.hide_all_print_button_group_batch_transfer')
