...
class AccountMove(models.Model):
    ...
    Methods:
        fields_view_get(self, views, options=None): Function to make print
        button invisible according to the boolean field in res.users."""
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False,
        ...
        if ((view_type in ['tree', 'form'] and self.env.user.has_group(
                'hide_all_print_button.hide_all_print_button_group_invoice')
