...
class TestPurchaseOrder(TransactionCase):
    ...
    def _create_print_action(self):
        model = self.env["ir.model"]._get("purchase.order")
    ...
    def _get_print_toolbar(self):
        views = self.env["purchase.order"].get_views(
