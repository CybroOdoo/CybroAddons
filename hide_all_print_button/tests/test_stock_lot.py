...
class TestStockLot(TransactionCase):
    ...
    def _create_print_action(self):
        model = self.env["ir.model"]._get("stock.lot")
    ...
    def _get_print_toolbar(self):
        views = self.env["stock.lot"].get_views(
    ...
    def test_get_views_hides_stock_lot_print_buttons(self):
