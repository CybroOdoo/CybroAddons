...
class TestStockPackage(TransactionCase):

    def _create_print_action(self):
        model = self.env["ir.model"]._get("stock.package")
    ...
    def _get_print_toolbar(self):
        views = self.env["stock.package"].get_views(
    ...
    def _assert_print_buttons_are_hidden(self):
        ...
        self.env.user.write({
            ...
            "hide_stock_quant_package_print": False,
        })
        ...
        self.env.user.write({
            ...
            "hide_stock_quant_package_print": True,
        })
    ...
    def test_get_views_hides_stock_package_print_buttons(self):
