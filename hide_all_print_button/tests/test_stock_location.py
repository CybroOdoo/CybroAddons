...
class TestStockLocation(TransactionCase):
    ...
    def _create_print_action(self):
        model = self.env["ir.model"]._get("stock.location")
    ...
    def _get_print_toolbar(self):
        views = self.env["stock.location"].get_views(
    ...
    def _assert_print_buttons_are_hidden(self):
        ...
        self.env.user.write({
            ...
            "hide_stock_location_print": False,
        })
        ...
        self.env.user.write({
            ...
            "hide_stock_location_print": True,
        })
    ...
    def test_get_views_hides_stock_location_print_buttons(self):
