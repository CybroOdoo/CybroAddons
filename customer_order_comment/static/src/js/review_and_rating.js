...
publicWidget.registry.CustomerReviewProduct = publicWidget.Widget.extend({
    ...
    /**
     * Highlight stars on hover based on the hovered star value.
     */
    ...
    /**
     * Remove hover effect from all stars when mouse leaves.
     */
    _ReviewOut: function () {
        const stars = this.el.querySelectorAll(".stars-box .star");
      ...
      /**
     * Handle rating submission when a star is clicked.
     * Updates selected stars, rating message, hidden fields,
     * and displays appropriate feedback tags.
     **/
    ...
    _SubmitCompliment: function () {
     ...
     /**
     * Handle feedback tag selection.
     * Enables or disables the submit button based on selected tags.
     *
     */
