...
class ProductTemplate(models.Model):
    ...
    def calculate_total_tax_percentage(self, tax):
        ...
        # Fixed Taxes
        elif tax.amount_type == 'fixed' and self.list_price:
            total_percentage_tax = (tax.amount / self.list_price) * 100
        # Division Taxes
        elif tax.amount_type == 'division' and tax.factor:
            total_percentage_tax = ((1 / tax.factor) - 1) * 100
