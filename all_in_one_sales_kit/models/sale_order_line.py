...
class SaleOrderLine(models.Model):
    ...
    def _action_launch_stock_rule(self, previous_product_uom_qty=False):
        ...
        for line in self:
            ...
            # Odoo 19: Use reference instead of procurement group
            ...
            # Odoo 19: Use stock.rule.Procurement instead of procurement.group.Procurement
    ...
    def _onchange_product_id(self):
        """Populate stock values and barcode on product select based on restriction."""
