...
################################################################################
{
    ...
    'depends': ['base', 'mail', 'web', 'html_editor', 'purchase_stock'],
    'data': [
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'https://cdn.jsdelivr.net/npm/tui-color-picker@2.2.6/dist/tui-color-picker.min.js',
            ...
            'https://cdn.jsdelivr.net/npm/tui-image-editor@3.2.2/dist/tui-image-editor.min.css',
