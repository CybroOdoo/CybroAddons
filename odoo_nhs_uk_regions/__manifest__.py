...
#############################################################################
{
    'name': 'NHS Trust — UK Regions Extension',
    'summary': 'Extend NHS Trust management for Wales and Northern Ireland, Odoo for NHS',
    'description': """NHS Trust Management - UK Regions Extension,NHS,NHS Odoo, NHS Trust Management,
