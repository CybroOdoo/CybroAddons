...
class WebsiteSale(WebsiteSale):
    """For adding the whatsapp_product_inquiry and whatsapp_number_validator
    functions"""

    @http.route(['/whatsapp_number/validator'], type='json', auth="public",
                website=True)
    def whatsapp_number_validator(self, **kw):
        """If company Whatsapp number is added, it returns true."""
        return bool(request.website.get_current_website().company_id.
                    whatsapp_number)
