...
class PurchaseOrderLine(models.Model):
    """ Inherits the Purchase order Line model to include
    ...
    @api.onchange('area_m2', 'price_per_m2', 'product_qty')
    ...
    def _prepare_account_move_line(self, move=False):
        """Include product dimension fields (length, width, area, price/m²) in vendor bill line."""
