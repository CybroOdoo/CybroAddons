...
publicWidget.registry.GreenscapeTheme = publicWidget.Widget.extend({
    ...
    /**
     * Initialize all interactive Greenscape website behaviors.
     *
     * @returns {Promise|undefined} Result returned by the parent widget start method.
     */
    start: function () {
    ...
    /**
     * Toggle the navbar scrolled state when the page moves past the hero area.
     */
    ...
    /**
     * Bind mobile menu open, close, and accessibility state handlers.
     */
    ...
    /**
     * Mark the navigation link that matches the current page URL as active.
     */
    ...
    /**
     * Filter portfolio cards by the selected project category.
     */
    ...
    /**
     * Smoothly scroll to in-page anchor targets while accounting for the navbar.
     */
     ...
     *
     * @param {string} msg Notification message to show.
     * @param {string} [type='success'] Notification style type.
     */
