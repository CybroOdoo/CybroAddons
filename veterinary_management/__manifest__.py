...
################################################################################
{
    ...
    'data': [
        ...
        'wizard/veterinary_management_views.xml',
        'report/prescription_order_views.xml',
        'report/prescription_order_templates.xml',
        'report/veterinary_management_reports.xml',
        'report/veterinary_management_templates.xml',
    ...
    'assets': {
            'web.assets_backend': [
                'veterinary_management/static/src/js/veterinary_dashboard.js',
                'veterinary_management/static/src/xml/veterinary_dashboard_views.xml',
