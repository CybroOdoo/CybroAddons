...
class VeterinaryEmployees(models.Model):
    ...
    consultancy_charges = fields.Monetary(string='Consultancy Charges',copy="False", required=True, help="Consultancy charges.")
    ...
    sunday = fields.Boolean(string="Sunday", help="Availability on Sunday.")
    monday = fields.Boolean(string="Monday", help="Availability on Monday.")
    tuesday = fields.Boolean(string="Tuesday", help="Availability on Tuesday.")
    wednesday = fields.Boolean(string="Wednesday", help="Availability on Wednesday.")
    thursday = fields.Boolean(string="Thursday", help="Availability on Thursday.")
    friday = fields.Boolean(string="Friday", help="Availability on Friday.")
    saturday = fields.Boolean(string="Saturday", help="Availability on Saturday.")
