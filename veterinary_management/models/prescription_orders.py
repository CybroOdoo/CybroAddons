...
class PrescriptionOrders(models.Model):
    """Fields to store prescription orders in veterinary Management"""
    ...
    def create(self, vals_list):
        ...
        if vals_list.get('prescription_no', 'New') == 'New':
            vals_list['prescription_no'] = self.env['ir.sequence'].next_by_code('prescription.sequence') or 'New'
