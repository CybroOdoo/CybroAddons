...
class ResPatient(models.Model):
    """Model for storing details about animal patients in the veterinary management system."""
    _name = 'res.patient'
    ...
    def get_count_data(self):
        """
        Fetches and returns various counts related to veterinary management data.
    ...
    def create(self, vals_list):
        ...
        if vals_list.get('number', 'New') == 'New':
            vals_list['number'] = self.env['ir.sequence'].next_by_code('appointment.sequence') or 'New'
        return super().create(vals_list)


class MedicalHistoryDetails(models.Model):
    """
    Model to store the medical history of an animal patient in a veterinary management system.
