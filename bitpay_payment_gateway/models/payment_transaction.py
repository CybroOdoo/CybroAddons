...
class PaymentTransaction(models.Model):
    ...
    def _get_tx_from_notification_data(self, provider_code, notification_data):
        ...
        if not reference:
            ...
            raise ValidationError(_("BitPay: Received data with missing orderId reference."))
        ...
        if not tx:
            ...
            raise ValidationError(_("BitPay: No transaction found for reference %s.", reference))
