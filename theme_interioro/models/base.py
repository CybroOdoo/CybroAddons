...
class InterioroPublishMixin(models.AbstractModel):
    ...
    image = fields.Image('Main Image', help='Main Image', max_width=1200, max_height=900)
    ...
    is_published = fields.Boolean('Published on Website', default=True, help='Published on Website')
