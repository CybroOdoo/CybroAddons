...
class SaleOrderCancel(http.Controller):
    """ Controller to handle the cancellation of a sale order. This controller
    provides an API endpoint to update the cancellation reason and state of a
    sale order to 'cancel'. The controller is accessible through a JSON API. """
