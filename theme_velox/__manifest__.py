...
###############################################################################
{
    ...
    'description': 'Velox is a premium, dark-themed sports eCommerce theme designed for high-performance brands. It includes custom snippets, tailored shop layouts, and slick animations to elevate your online store.',
    'author': 'Cybrosys Techno Solutions',
    'company': 'Cybrosys Techno Solutions',
    'maintainer': 'Cybrosys Techno Solutions',
    'website': 'https://www.cybrosys.com',
    'support': 'info@cybrosys.com',
    'depends': ['website', 'website_sale'],
    'data': [
        'data/categories_data.xml',
        'data/attributes_data.xml',
