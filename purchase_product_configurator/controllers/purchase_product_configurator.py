...
class ProductConfiguratorController(Controller):
    ...
    @route('/purchase_product_configurator/get_values', type='jsonrpc', auth='user')
    ...
    @route('/purchase_product_configurator/create_product', type='jsonrpc', auth='user')
    ...
    @route('/purchase_product_configurator/update_combination', type='jsonrpc', auth='user')
    ...
    @route('/purchase_product_configurator/get_optional_products', type='jsonrpc', auth='user')
