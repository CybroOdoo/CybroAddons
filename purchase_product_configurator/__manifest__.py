...
###############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            'purchase_product_configurator/static/src/js/purchase_utils.js',
            ...
            'purchase_product_configurator/static/src/js/quantity_buttons/quantity_buttons.js',
            'purchase_product_configurator/static/src/js/quantity_buttons/quantity_buttons.scss',
            'purchase_product_configurator/static/src/js/quantity_buttons/quantity_buttons.xml',
