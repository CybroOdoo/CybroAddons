...
export class ProductTemplateAttributeLine extends Component {
    static template = "purchase.ProductTemplateAttributeLine";
    static props = {
...
//                    price_extra: Number,
    ...
    getPTAVTemplate() {
        switch(this.props.attribute.display_type) {
            case 'select':
                return 'purchase.ptav_select';
            case 'radio':
                return 'purchase.ptav_radio';
            case 'pills':
                return 'purchase.ptav_pills';
            case 'color':
                return 'purchase.ptav_color';
            case 'multi':
                return 'purchase.ptav_multi';
            case 'image':
                return 'purchase.ptav_image';
        }
    }
    /**
     ...
     * Note: used in `purchase.ptav_select`.
     *
