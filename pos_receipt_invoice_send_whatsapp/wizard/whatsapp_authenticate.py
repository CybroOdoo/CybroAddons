...
class WhatsappAuthenticate(models.TransientModel):
    ...
    qrcode = fields.Binary(attachment=False, string="Qr Code", help="QR code for scanning")
    configuration_manager_id = fields.Many2one("configuration.manager", string="Configuration Manager",
