...
#############################################################################
{
    ...
    'assets': {
        ...
        'web.assets_unit_tests': [
            ...
            'product_detail_search/static/src/js/find_product.js',
            'product_detail_search/static/src/js/product_details.js',
            'product_detail_search/static/tests/unit/find_product_button.test.js',
            'product_detail_search/static/tests/unit/find_product.test.js',
            'product_detail_search/static/tests/unit/product_details.test.js',
        ],
    },
    'license': 'LGPL-3',
    'installable': True,
